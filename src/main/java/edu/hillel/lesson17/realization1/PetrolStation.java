package edu.hillel.lesson17.realization1;
...
public class PetrolStation {
    private final static AtomicInteger amount = new AtomicInteger(1000);
    ...
    public static void main(String[] args) {
        ...
        while (amount.get() >= MINIMAL_FUEL_AMOUNT) {
            executorService.submit(() -> {
                ...
                System.out.println("Task delay=" + delay + ", fuelAmount=" + fuelAmount + " start fuel to car");
                try {
                    Thread.sleep(delay);
